...
namespace GumTree.Helper
{
    public class ApplicationData
    {
        ...
        public static string CycleDelay = string.Empty;
        ...
        public static bool ResizeImageAfterUpload = false;
        public static string SpamUrl = string.Empty;
        public static bool Isloggedin { get; set; }
        public static string ProgressReport = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Gumtree_Logger";
    }
}
